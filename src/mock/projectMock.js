...
mock.onGet('/api/projects').reply(200, {
  projects: [
    ...
    },
    {
      ...
      members: 3,
      cover_image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4GUU4_DpmVXnX51AC6526kRDa_JimW1dpr2_N3hgp5bXmPaw&s',
      start_date: moment(),
      end_date: moment(),
    ...
    },
    {
      ...
      members: 8,
      cover_image:
        'https://vikrantbhingardive.com/wp-content/uploads/2020/02/digital-marketing-campaign-1.jpg',
      start_date: moment(),
      end_date: moment(),
